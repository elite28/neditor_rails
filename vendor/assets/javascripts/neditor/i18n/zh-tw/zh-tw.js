UE.I18N['zh-tw'] = {
    'labelMap':{
        'anchor':'錨點', 'undo':'還原上一步', 'redo':'重做', 'bold':'粗體', 'indent':'首行縮排', 'snapscreen':'截圖',
        ...
        'insertvideo':'影片', 'help':'幫助', 'justifyleft':'置左對齊', 'justifyright':'置右對齊', 'justifycenter':'置中對齊',
        'justifyjustify':'兩端對齊', 'forecolor':'字型顏色', 'backcolor':'背景色', 'insertorderedlist':'有序列表',
        'insertunorderedlist':'無序列表', 'fullscreen':'全螢幕', 'directionalityltr':'從左向右輸入', 'directionalityrtl':'從右向左輸入',
        ...
        'webapp':'web應用','touppercase':'字母大寫', 'tolowercase':'字母小寫','background':'背景','template':'模板','scrawl':'塗鴉',
        'music': '音樂','inserttable': '插入表格','drafts': '從草稿匣載入', 'charts': '圖表'
    },
    'insertorderedlist':{
        'num':'1,2,3...',
        'num1':'1),2),3)...',
    ...
    'autoupload': {
        ...
        'exceedTypeError': '檔案格式不正確',
        'jsonEncodeError': '伺服器回傳格式錯誤',
        'loading':"正在上傳...",
        'loadError':"上傳錯誤",
        'errorLoadConfig': '後端設定沒有正常載入，上傳外掛無法正常使用。'
    },
    'simpleupload':{
        'exceedSizeError': '檔案大小超出限制',
        'exceedTypeError': '檔案格式不正確',
    ...
    'loadconfigError': '獲取後臺設定值請求出錯，上傳功能將無法正常使用。',
    'loadconfigFormatError': '後臺設定值回傳格式出錯，上傳功能將無法正常使用。',
    'loadconfigHttpError': '請求後臺設定值http錯誤，上傳功能將無法正常使用。',
    'snapScreen_plugin':{
        'browserMsg':"僅支援 IE 瀏覽器。",
        'callBackErrorMsg':"伺服器回傳資料有誤，請檢查設定值之後重試。",
    ...
    'confirmClear':"確定清空目前文字嗎？",
    'contextMenu':{
        'delete':"刪除",
        'selectall':"全選",
        'deletecode':"刪除程式碼",
        'cleardoc':"清空文件",
        'confirmclear':"確定清空目前文字？",
        'unlink':"刪除超連結",
        'paragraph':"段落格式",
        'edittable':"表格屬性",
        'aligntd':"單元格對齊方式",
    ...
    'background':{
        'static':{
            ...
            'repeatType':{'options':["置中", "橫向重複", "縱向重複", "平鋪","自定義"]}

        },
        'noUploadImage':"目前未上傳過任何圖片。",
        'toggleSelect': "單擊可切換選擇狀態\\n原圖尺寸: "
    },
    //===============dialog i18N=======================
    'insertimage':{
        'static':{
            ...
            'searchType':{'title':"圖片型別", 'options':["新聞", "桌布", "表情", "大頭照"]}, //select的option
            'searchTxt':{'value':"請輸入搜尋關鍵詞"},
            'searchBtn':{'value':"搜尋"},
            'searchReset':{'value':"清空搜尋"},
            'noneAlign':{'title':'無浮動'},
            'leftAlign':{'title':'左浮動'},
    ...
    'attachment':{
        'static':{
            ...
            'lang_start_upload':"開始上傳",
            'lang_drop_remind':"可以將檔案拖到這裡，單次最多可選 100 個檔案"
        },
    ...
    'insertvideo':{
        ...
        'statusPrompt':' 個檔案已上傳。 ',
        'flashVersionError':'目前Flash版本過低，請更新FlashPlayer後重試。',
    ...
    'scrawl':{
        ...
        'noScarwl':"尚未作畫，白紙一張~",
        'scrawlUpLoading':"塗鴉上傳中",
        'continueBtn':"繼續",
        'imageError':"糟糕，圖片讀取失敗了。",
        'backgroundUploading':'背景圖片上傳中'
    },
    'music':{
        'static':{
    ...
    'help':{
        'static':{
            ...
            'lang_input_introduction':'introduction',
            'lang_Txt_shortcuts':'快捷鍵',
            'lang_Txt_func':'功能',
            'lang_Txt_bold':'給選擇字設定為粗體',
            'lang_Txt_copy':'複製選擇內容',
            'lang_Txt_cut':'剪下選擇內容',
            'lang_Txt_Paste':'貼上',
            'lang_Txt_undo':'重新執行上次操作',
            'lang_Txt_redo':'撤銷上一次操作',
            'lang_Txt_italic':'給選擇字設定為斜體',
            'lang_Txt_underline':'給選擇字加下劃線',
            'lang_Txt_selectAll':'全部選擇',
            'lang_Txt_visualEnter':'虛擬enter',
    ...
    'insertframe':{
        'static':{
            ...
            'align':{title:"對齊方式", options:["預設", "左對齊", "右對齊", "置中"]}
        },
        'enterAddress':'請輸入地址。'
    },
    'link':{
        ...
        'validLink':'只支援選擇一個連結時生效',
        'httpPrompt':'您輸入的超連結中不包含http等協議名稱，預設將為您新增http://字首'
    },
    'map':{
        'static':{
            lang_city:"城市",
    ...
    'searchreplace':{
        'static':{
            ...
            lang_search2:"查詢",
            lang_replace:"替換",
            lang_searchReg:'支援正規表示式，新增前後斜槓標示為正規表示式，例如「/表示式/」',
            lang_searchReg1:'支援正規表示式，新增前後斜槓標示為正規表示式，例如「/表示式/」',
    ...
    'snapscreen':{
        'static':{
            lang_showMsg:"截圖功能需要首先安裝截圖外掛。 ",
            lang_download:"點此下載",
            lang_step1:"第一步，下載截圖外掛並執行安裝。",
            lang_step2:"第二步，外掛安裝完成後即可使用，如不生效，請重啟瀏覽器後再試。"
        }
    },
    'spechars':{
        'static':{},
    ...
    'wordimage':{
        'static':{
            ...
            lang_step:"1、點選頂部複製按鈕，將地址複製到剪貼簿；2、點選新增照片按鈕，在彈出的對話方塊中使用Ctrl+V貼上地址；3、點選開啟後選擇圖片上傳流程。"
        },
        'fileType':"圖片",
